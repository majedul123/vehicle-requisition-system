...
<title>MBSTU Car Requisition | Contact Us</title>
<!--Bootstrap -->
...
{ ?>
          <ul>
            <li>
              ...
              <div class="contact_info_m"><a href="https://mbstu.ac.bd" target="_blank">MBSTU</a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="tel:+88092151899" >+88092151899</a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m">register@mbstu.ac.bd</div>
            </li>
          </ul>
        <?php }} ?>
        </div>
